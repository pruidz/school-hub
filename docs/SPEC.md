...
| P3 | შემოწმების ეკრანი | **იხილე 4b — გადაკეთებულია ცდების ქრონოლოგიად** |
...
## 4b. P3 — შემოწმების ეკრანი v2 (მომხმარებლის მოთხოვნა, 2026-09-18)

პირველი ვერსია ორად ყოფდა ეკრანს: მარცხნივ დავალება, მარჯვნივ ამოხსნა. ორი პრობლემა
გამოჩნდა რეალურ გამოყენებაში:

1. **ფოტოები ზედმეტად დიდია** — ეკრანს ავსებს, დათვალიერება რთულია.
2. **ისტორია არ ჩანს.** დავალება შეიძლება სამჯერ დაბრუნდეს. ამჟამად ყველა ფოტო ერთ
   გროვაშია და ვერ იგებ, რომელი ცდა რომელია და რა შენიშვნა მიეცა რომელზე.

### ახალი აგებულება — ერთი ქრონოლოგია

ეკრანი ერთი ვერტიკალური ნაკადია, ზემოდან ქვემოთ:

```
┌─────────────────────────────────────────────┬──────────────┐
│ სათაური · საგანი · ვადა · სტატუსი           │              │
├─────────────────────────────────────────────┤              │
│ დავალება (წიგნის ფოტო) — კომპაქტური,        │    ჩ ა ტ ი   │
│ დასაწკაპუნებლად იხსნება მთელ ეკრანზე        │              │
├─────────────────────────────────────────────┤  (გვერდით    │
│ ცდა 1 — ჩააბარა 12 სექტ. 19:40              │   დესკტოპზე, │
│   მინიატურები · ხმოვანი ჩანაწერი            │   ქვემოთ     │
│   თვითშეფასება 3/5 · 25 წთ · „გამიჭირდა…"   │   ტელეფონზე) │
│   ↻ დააბრუნე: „მეორე და მესამე არასწორია"   │              │
├─────────────────────────────────────────────┤              │
│ ცდა 2 — ჩააბარა 12 სექტ. 21:10              │              │
│   …                                          │              │
├─────────────────────────────────────────────┤              │
│ ცდა 3 — ახლა შესამოწმებელი                  │              │
├─────────────────────────────────────────────┴──────────────┤
│              ✓ დადასტურება      ↻ გადასაკეთებელი           │
└─────────────────────────────────────────────────────────────┘
```

**ცდა** = ერთი ჩაბარება და მასზე შენი ვერდიქტი. `redo_count = 2` ნიშნავს სამ ცდას.
ყოველი ცდის ბლოკში: **ზუსტად იმ ცდის** მტკიცებულება (ფოტოები და/ან ჩანაწერები),
ბავშვის თვითშეფასება და შენიშვნა, და შენი გადაწყვეტილება კომენტარით.
უახლესი ცდა გახსნილია, ძველები დაკეცილი — მაგრამ ხელმისაწვდომი.

### ვიზუალური მოთხოვნები

- ფოტოები **მინიატურებია** ბადეში, არა გვერდის სიგანის სურათები. დაწკაპუნებით —
  მთელ ეკრანზე, გადიდებით (ეს უკვე მუშაობს).
- ხმოვანი ჩანაწერი იმავე ბლოკში, ფოტოების გვერდით, არა ცალკე სიაში.
- სამი განსხვავებული ცდა ვიზუალურად უნდა განირჩეოდეს ერთმანეთისგან — ეს არის
  ერთადერთი ადგილი, სადაც ჩანს ბავშვი გაუმჯობესდა თუ არა.
- ჩატი გვერდით დესკტოპზე, ქვემოთ ტელეფონზე. ერთი გაკვეთილის ყველაფერი ერთ გვერდზე.

### ტექნიკური შენიშვნა

`attachments`-ს არ აქვს ცდის ნომერი. ის ან უნდა დაემატოს (და არსებული მონაცემი
შეივსოს), ან გამოითვალოს `assignment_events`-ის დროებთან შედარებით. მთავარია
**უკვე არსებული დავალებებიც სწორად დაიყოს**, არა მხოლოდ ახლები.
