...
-- It is the same statements the numbered files contain, in the same order,
-- wrapped in a single transaction so a failure leaves nothing half-applied.
--
-- Files included: 0001_extensions.sql, 0002_core_tables.sql, 0003_functions.sql, 0004_rls.sql, 0005_storage.sql, 0006_lesson_no_homework.sql, 0007_privilege_hardening.sql, 0008_sibling_identity_scope.sql, 0009_realtime_notifications.sql, 0010_helper_role.sql, 0011_notify_parent_on_helper_review.sql
-- =====================================================================
